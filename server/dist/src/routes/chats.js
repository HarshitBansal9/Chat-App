...
router.post("/sendmessage", async (req, res) => {
    ...
    const newMessage = await db_1.default.query("INSERT INTO messages (chat_id,sender_id,message_text,image_url,sent_at) VALUES ($1,$2,$3,$4,$5) RETURNING *", [chatId, id, messageText, image, time]);
